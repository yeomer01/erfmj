...
export function Toast({ message, type, onClose }) {
  ...
  return (
    <div className={`fixed bottom-0 right-0 m-6 ${bgClass} text-white px-6 py-4 shadow-2xl z-[9999] flex items-center gap-3 animate-in slide-in-from-bottom-5 fade-in duration-300 font-medium border-l-4 border-white/30 rounded-none`}>
