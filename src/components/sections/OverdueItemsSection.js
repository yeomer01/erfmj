                  ...
                  return (
                    <tr key={item.id} className="hover:bg-amber-50/20 transition-colors group">
                      ...
                      <td className="px-5 py-3 text-center">
                        <span className="bg-red-50 text-red-600 px-2.5 py-1 rounded-full font-bold border border-red-100 shadow-sm text-[11px]">+{diffDays}일</span>
                      </td>
                      <td className="px-5 py-3 text-center grid gap-1">
                        {hasWriteAccess && (
                          <>
                            <button onClick={() => onRequestDeduction(item)} className="w-full px-2 py-1.5 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 hover:text-indigo-700 border border-indigo-200 rounded-md text-[11px] font-bold transition-all shadow-sm">차감요청</button>
                            <button onClick={() => onEdit(item)} className="w-full px-2 py-1.5 bg-white text-stone-600 hover:text-blue-600 hover:border-blue-300 border border-stone-200 rounded-md text-[11px] font-bold transition-all shadow-sm">처리하기</button>
                          </>
                        )}
                      </td>
                    </tr>
